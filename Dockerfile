...
apt-get update && apt-get install -y curl libc6:armhf box86:armhf vim git cmake python3 gcc-arm-linux-gnueabihf;
...
cd box86;\
mkdir build; cd build; cmake .. -DADLINK=1 -DCMAKE_BUILD_TYPE=RelWithDebInfo;\
make -j4;\
make install
